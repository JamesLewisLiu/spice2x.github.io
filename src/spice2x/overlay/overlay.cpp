...
void overlay::SpiceOverlay::init() {
    ...
    // Text
    colors[ImGuiCol_Text] = ImVec4(0.98f, 0.99f, 1.00f, 1.00f); // clean white
    colors[ImGuiCol_TextDisabled] = ImVec4(0.58f, 0.66f, 0.78f, 1.00f);

    // Backgrounds
    colors[ImGuiCol_WindowBg] = ImVec4(0.05f, 0.08f, 0.14f, 1.00f); // deep navy blue
    colors[ImGuiCol_ChildBg] = ImVec4(0.07f, 0.11f, 0.18f, 1.00f);
    colors[ImGuiCol_PopupBg] = ImVec4(0.06f, 0.10f, 0.17f, 0.96f);

    // Borders
    colors[ImGuiCol_Border] = ImVec4(0.48f, 0.70f, 0.95f, 0.65f);
    colors[ImGuiCol_BorderShadow] = ImVec4(0.00f, 0.00f, 0.00f, 0.00f);

    // Frames
    colors[ImGuiCol_FrameBg] = ImVec4(0.11f, 0.18f, 0.29f, 1.00f);
    colors[ImGuiCol_FrameBgHovered] = ImVec4(0.18f, 0.34f, 0.55f, 1.00f);
    colors[ImGuiCol_FrameBgActive] = ImVec4(0.30f, 0.52f, 0.80f, 1.00f);

    // Title Bars
    colors[ImGuiCol_TitleBg] = ImVec4(0.07f, 0.12f, 0.22f, 1.00f);
    colors[ImGuiCol_TitleBgActive] = ImVec4(0.22f, 0.36f, 0.62f, 1.00f);
    colors[ImGuiCol_TitleBgCollapsed] = ImVec4(0.04f, 0.07f, 0.13f, 1.00f);

    // Menus
    colors[ImGuiCol_MenuBarBg] = ImVec4(0.08f, 0.14f, 0.24f, 1.00f);
    ...
    colors[ImGuiCol_ScrollbarGrabActive] = ImVec4(0.95f, 0.46f, 0.72f, 1.00f);

    // Interactables (pink highlights on blue controls)
    colors[ImGuiCol_CheckMark] = ImVec4(1.00f, 0.55f, 0.78f, 1.00f);
    colors[ImGuiCol_SliderGrab] = ImVec4(0.70f, 0.82f, 1.00f, 1.00f);
    colors[ImGuiCol_SliderGrabActive] = ImVec4(1.00f, 0.55f, 0.78f, 1.00f);
    colors[ImGuiCol_Button] = ImVec4(0.16f, 0.32f, 0.58f, 1.00f);
    colors[ImGuiCol_ButtonHovered] = ImVec4(0.95f, 0.42f, 0.70f, 1.00f);
    colors[ImGuiCol_ButtonActive] = ImVec4(1.00f, 0.62f, 0.82f, 1.00f);
    colors[ImGuiCol_Header] = ImVec4(0.16f, 0.32f, 0.58f, 1.00f);
    colors[ImGuiCol_HeaderHovered] = ImVec4(0.32f, 0.55f, 0.85f, 1.00f);
    colors[ImGuiCol_HeaderActive] = ImVec4(0.95f, 0.42f, 0.70f, 1.00f);

    // Tabs
    colors[ImGuiCol_Tab] = ImVec4(0.10f, 0.20f, 0.36f, 1.00f);
    colors[ImGuiCol_TabHovered] = ImVec4(0.95f, 0.42f, 0.70f, 1.00f);
    colors[ImGuiCol_TabActive] = ImVec4(0.24f, 0.44f, 0.72f, 1.00f);

    // Misc
    colors[ImGuiCol_PlotLines] = ImVec4(0.70f, 0.82f, 1.00f, 1.00f);
    colors[ImGuiCol_TextSelectedBg] = ImVec4(1.00f, 0.55f, 0.78f, 0.35f);
    colors[ImGuiCol_NavHighlight] = ImVec4(1.00f, 0.55f, 0.78f, 1.00f);
    ...
    colors[ImGuiCol_SeparatorActive]  = ImVec4(1.00f, 0.55f, 0.78f, 1.00f);
    colors[ImGuiCol_ModalWindowDimBg] = ImVec4(0.88f, 0.94f, 1.00f, 0.45f);

#ifdef IMGUI_HAS_DOCK
    colors[ImGuiCol_DockingPreview] = ImVec4(1.00f, 0.55f, 0.78f, 0.40f);
